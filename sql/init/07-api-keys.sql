...
CREATE INDEX idx_user_oauth_tokens_service ON user_oauth_tokens(service);
...
CREATE INDEX idx_user_oauth_tokens_service_user ON user_oauth_tokens(service, user_id) WHERE expires_at > CURRENT_TIMESTAMP;
