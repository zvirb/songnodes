...
export const SettingsIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m11-7h-6m-6 0H1m11 7a4 4 0 0 1-8 0 4 4 0 0 1 8 0zM7 10a4 4 0 0 1 8 0 4 4 0 0 1-8 0z" />
  </svg>
);
...
export const FitToScreenIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
